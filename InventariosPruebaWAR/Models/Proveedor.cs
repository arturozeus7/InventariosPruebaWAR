...
namespace InventariosPruebaWAR
{
    public class Proveedor
    {
        ...
        public Proveedor(int PidProveedor, int PidEmpresa, string PEmpresa, int PDiasCredito, double PCantidadCredito,
            string PNumeroTarjeta, int PidBanco, string PBanco, int PidTipodePago, string PTipodePago, string PNombre, string PCorreo, string PTelefono)
        {
